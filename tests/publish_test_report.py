...
This script creates a link to the HTML BDD test report and appends it to the
...
Script dependencies: none of the non-standard libraries.
"""
...
def get_report_description() -> str:
    ...
    """
    return f"\n\nHTML BDD execution report: {get_report_link()}\n\n"
