...
from tests.test_harness2.constant import SIMULATOR_DEVICE_FQDN_DICT
...
# NOTE: GB renamed this to TestHarnessFactory and added here methods
# to read ENV, create the TestHarness itself etc.
