...
# - occorre fare un fault injection
# - e verifico che sia ancora nello stato di partenza
# if starting_state in TRANSIENT_STATES:
#     assert_that(event_tracer).described_as(
#         "FAILED ASSUMPTION: "
#         "TMC Subarray Node device "
...
#     )
#     # oppure
#     # assert_that(event_tracer).attribute_value_is('subarray_node_facade.subarray_node',
#     # 'ObsState', starting_state)
#
# When the automatic Assigned event occurs on the subarray 001
# - induco il SA a fare il assigned event
# - e verifico che sia ancora nello stato di partenza
#
#
# When the automatic Released event occurs on the subarray 001
# - induco il SA a fare il released event
# - e verifico che sia ancora nello stato di partenza
#
# When the automatic All released event occurs on the subarray 001
# - induco il SA a fare il all released event
# - e verifico che sia ancora nello stato di partenza
#
