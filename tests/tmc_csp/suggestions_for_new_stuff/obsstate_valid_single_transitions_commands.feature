...
# following scenarios are for the abort-restart commands
  # they have been moved to abort_restart_subarray.feature
...
#  Then the subarray 1 should transition to the EMPTY state
  ...
  # following scenarios are for the observation fault
